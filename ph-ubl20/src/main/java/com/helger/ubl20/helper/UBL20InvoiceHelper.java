...
public final class UBL20InvoiceHelper
{
  ...
  public static void cloneToCreditNoteLine (@Nonnull final InvoiceLineType aSrc, @Nonnull final CreditNoteLineType aDst)
  {
    ...
    // Not present
    /*
     * { final List <AllowanceChargeType> retAllowanceCharge = new ArrayList <> (); for (final
     * AllowanceChargeType aItem : src.getAllowanceCharge ()) retAllowanceCharge.add (aItem == null
     * ? null : aItem.clone ()); ret.setAllowanceCharge (retAllowanceCharge); }
     */
    {
    ...
    // Not present
    /*
     * ret.setDeliveryTerms (src.getDeliveryTerms () == null ? null : src.getDeliveryTerms ().clone
     * ());
     */
    {
    ...
    // Not present
    /*
     * ret.setFreeOfChargeIndicator (src.getFreeOfChargeIndicator () == null ? null :
     * src.getFreeOfChargeIndicator ().clone ());
     */
    ...
    // Not present
    /*
     * { final List <OrderLineReferenceType> retOrderLineReference = new ArrayList <> (); for (final
     * OrderLineReferenceType aItem : src.getOrderLineReference ()) retOrderLineReference.add (aItem
     * == null ? null : aItem.clone ()); ret.setOrderLineReference (retOrderLineReference); }
     */
    // Not present
    /*
     * ret.setOriginatorParty (src.getOriginatorParty () == null ? null : src.getOriginatorParty
     * ().clone ());
     */
    // Not present
    /*
     * { final List <PaymentTermsType> retPaymentTerms = new ArrayList <> (); for (final
     * PaymentTermsType aItem : src.getPaymentTerms ()) retPaymentTerms.add (aItem == null ? null :
     * aItem.clone ()); ret.setPaymentTerms (retPaymentTerms); }
     */
  ...
  public static void cloneInvoiceToCreditNote (@Nonnull final InvoiceType aSrc, @Nonnull final CreditNoteType aDst)
  {
    ...
    // Not present
    /*
     * { final List <DeliveryType> retDelivery = new ArrayList <> (); for (final DeliveryType aItem
     * : src.getDelivery ()) retDelivery.add (aItem == null ? null : aItem.clone ());
     * ret.setDelivery (retDelivery); }
     */
    // Not present
    /*
     * ret.setDeliveryTerms (src.getDeliveryTerms () == null ? null : src.getDeliveryTerms ().clone
    ...
    // Not present
    /*
     * ret.setInvoiceTypeCode (src.getInvoiceTypeCode () == null ? null : src.getInvoiceTypeCode
     * ().clone ());
     */
     ...
     * for (final DocumentReferenceType aItem : src.getOriginatorDocumentReference ())
     ...
     * PaymentMeansType aItem : src.getPaymentMeans ()) retPaymentMeans.add (aItem == null ? null :
     * aItem.clone ()); ret.setPaymentMeans (retPaymentMeans); }
     */
    // Not present
    /*
     * { final List <PaymentTermsType> retPaymentTerms = new ArrayList <> (); for (final
