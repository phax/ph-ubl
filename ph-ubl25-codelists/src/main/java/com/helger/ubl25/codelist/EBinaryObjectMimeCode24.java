...
/**
 * This file was automatically generated from Genericode file BinaryObjectMimeCode-2.4.gc. Do NOT edit!
 * It contains a total of 1844 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EBinaryObjectMimeCode24
    implements IHasID<String>
{
    ...
    @Nullable
    public static EBinaryObjectMimeCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EBinaryObjectMimeCode24 .class, sID);
    }
}
