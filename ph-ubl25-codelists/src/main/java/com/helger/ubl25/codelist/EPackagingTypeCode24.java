...
/**
 * This file was automatically generated from Genericode file PackagingTypeCode-2.4.gc. Do NOT edit!
 * It contains a total of 377 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EPackagingTypeCode24
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static EPackagingTypeCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EPackagingTypeCode24 .class, sID);
    }
