...
/**
 * This file was automatically generated from Genericode file PaymentMeansCode-2.4.gc. Do NOT edit!
 * It contains a total of 82 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EPaymentMeansCode24
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_ID = "UN/EDIFACT EDED 4461";
    public static final String LIST_VERSION = "18B";
    private final String m_sID;
    private final String m_sDisplayName;
    private final String m_sDescription;

    EPaymentMeansCode24(@NonNull @Nonempty final String sID, @NonNull final String sDisplayName, @Nullable final String sDescription) {
        m_sID = sID;
    ...
    @Nullable
    public static EPaymentMeansCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EPaymentMeansCode24 .class, sID);
    }
