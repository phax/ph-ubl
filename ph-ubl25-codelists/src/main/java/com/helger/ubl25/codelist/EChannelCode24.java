...
/**
 * This file was automatically generated from Genericode file ChannelCode-2.4.gc. Do NOT edit!
 * It contains a total of 47 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EChannelCode24
    implements IHasID<String> , IHasDisplayName
{
    ...
    EChannelCode24(@NonNull @Nonempty final String sID, @NonNull final String sDisplayName, @Nullable final String sDescription) {
        m_sID = sID;
    ...
    @Nullable
    public static EChannelCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EChannelCode24 .class, sID);
    }
