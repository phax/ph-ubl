...
/**
 * This file was automatically generated from Genericode file UnitOfMeasureCode-2.4.gc. Do NOT edit!
 * It contains a total of 1732 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EUnitOfMeasureCode24
    implements IHasID<String> , IHasDisplayName
{
    ...
    EUnitOfMeasureCode24(@NonNull @Nonempty final String sID, @NonNull final String sDisplayName) {
        m_sID = sID;
    ...
    @Nullable
    public static EUnitOfMeasureCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EUnitOfMeasureCode24 .class, sID);
    }
