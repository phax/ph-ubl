...
/**
 * This file was automatically generated from Genericode file AllowanceChargeReasonCode-2.4.gc. Do NOT edit!
 * It contains a total of 105 entries!
 * @author com.helger.ubl25.supplementary.tools.MainCreateEnumsGenericode25
 */
@CodingStyleguideUnaware
public enum EAllowanceChargeReasonCode24
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static EAllowanceChargeReasonCode24 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EAllowanceChargeReasonCode24 .class, sID);
    }
