...
public enum EUBL22DocumentType implements IJAXBDocumentType
{
  ...
  BILL_OF_LADING (oasis.names.specification.ubl.schema.xsd.billoflading_22.BillOfLadingType.class, "UBL-BillOfLading-2.2.xsd"),
  @Since ("2.2")
  BUSINESS_CARD(oasis.names.specification.ubl.schema.xsd.businesscard_22.BusinessCardType.class, "UBL-BusinessCard-2.2.xsd"),
  CALL_FOR_TENDERS (oasis.names.specification.ubl.schema.xsd.callfortenders_22.CallForTendersType.class, "UBL-CallForTenders-2.2.xsd"),
  ...
  CONTRACT_NOTICE (oasis.names.specification.ubl.schema.xsd.contractnotice_22.ContractNoticeType.class, "UBL-ContractNotice-2.2.xsd"),
  ...
  DESPATCH_ADVICE (oasis.names.specification.ubl.schema.xsd.despatchadvice_22.DespatchAdviceType.class, "UBL-DespatchAdvice-2.2.xsd"),
  @Since ("2.2")
  ...
  DOCUMENT_STATUS (oasis.names.specification.ubl.schema.xsd.documentstatus_22.DocumentStatusType.class, "UBL-DocumentStatus-2.2.xsd"),
  ...
  @Since ("2.2")
  ENQUIRY_RESPONSE(oasis.names.specification.ubl.schema.xsd.enquiryresponse_22.EnquiryResponseType.class, "UBL-EnquiryResponse-2.2.xsd"),
  ...
  FREIGHT_INVOICE (oasis.names.specification.ubl.schema.xsd.freightinvoice_22.FreightInvoiceType.class, "UBL-FreightInvoice-2.2.xsd"),
  ...
  INVENTORY_REPORT (oasis.names.specification.ubl.schema.xsd.inventoryreport_22.InventoryReportType.class, "UBL-InventoryReport-2.2.xsd"),
  ...
  ORDER_CHANGE (oasis.names.specification.ubl.schema.xsd.orderchange_22.OrderChangeType.class, "UBL-OrderChange-2.2.xsd"),
  ORDER_RESPONSE (oasis.names.specification.ubl.schema.xsd.orderresponse_22.OrderResponseType.class, "UBL-OrderResponse-2.2.xsd"),
  ...
  PACKING_LIST (oasis.names.specification.ubl.schema.xsd.packinglist_22.PackingListType.class, "UBL-PackingList-2.2.xsd"),
  ...
  PRODUCT_ACTIVITY (oasis.names.specification.ubl.schema.xsd.productactivity_22.ProductActivityType.class, "UBL-ProductActivity-2.2.xsd"),
  @Since ("2.2")
  ...
  RECEIPT_ADVICE (oasis.names.specification.ubl.schema.xsd.receiptadvice_22.ReceiptAdviceType.class, "UBL-ReceiptAdvice-2.2.xsd"),
  ...
  RETAIL_EVENT (oasis.names.specification.ubl.schema.xsd.retailevent_22.RetailEventType.class, "UBL-RetailEvent-2.2.xsd"),
  ...
  @Since ("2.2")
  TENDER_CONTRACT(oasis.names.specification.ubl.schema.xsd.tendercontract_22.TenderContractType.class, "UBL-TenderContract-2.2.xsd"),
  ...
  TENDER_RECEIPT (oasis.names.specification.ubl.schema.xsd.tenderreceipt_22.TenderReceiptType.class, "UBL-TenderReceipt-2.2.xsd"),
  @Since ("2.2")
  TENDER_STATUS(oasis.names.specification.ubl.schema.xsd.tenderstatus_22.TenderStatusType.class, "UBL-TenderStatus-2.2.xsd"),
  @Since ("2.2")
  ...
  @Since ("2.2")
  WEIGHT_STATEMENT(oasis.names.specification.ubl.schema.xsd.weightstatement_22.WeightStatementType.class, "UBL-WeightStatement-2.2.xsd");
  ...
  private EUBL22DocumentType (@Nonnull final Class <?> aClass, @Nonnull final String sXSDPath)
  {
    m_aDocType = new JAXBDocumentType (aClass,
                                       new CommonsArrayList <> (new ClassPathResource (CUBL22.SCHEMA_DIRECTORY + sXSDPath, _getCL ())),
