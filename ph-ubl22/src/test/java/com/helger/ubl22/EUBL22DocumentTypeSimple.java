 ...
 */
public enum EUBL22DocumentTypeSimple implements IUBLDocTypeEnumSimple
{
  ...
  EUBL22DocumentTypeSimple (@Nonnull final Class <?> aClass, @Nonnull final String sXSDPath)
  {
    m_aClass = aClass;
    m_sXSDPath = sXSDPath;
  }
