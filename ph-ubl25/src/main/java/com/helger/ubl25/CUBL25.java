...
/**
 * Constants for UBL 2.5 handling.
 *
 * @author Philip Helger
 */
@Immutable
public final class CUBL25
{
  private static final String PREFIX = "external/schemas/";

  /** The classpath relative directory where the main XSDs reside */
  public static final String SCHEMA_DIRECTORY = PREFIX + "ubl25/maindoc/";
  ...
  {
    return CUBL25.class.getClassLoader ();
  }
}
