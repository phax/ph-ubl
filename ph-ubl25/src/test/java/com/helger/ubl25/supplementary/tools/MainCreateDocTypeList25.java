 ...
 */
package com.helger.ubl25.supplementary.tools;
...
/**
 * Utility class that creates the content for EUBL25DocumentType
 *
 * @author Philip Helger
 */
public final class MainCreateDocTypeList25 extends AbstractUBLCodeGen
{
  public static void main (final String [] args)
  {
    ...
    {
      final String sBasePath = "src/main/resources/external/schemas/ubl25/" + sPart;
      for (final File aFile : getXSDFileList (sBasePath))
      {
        // UBL-CallForTenders-2.5.xsd
        ...
        {
          final String sPrevBasePath = "../ph-ubl24/src/main/resources/external/schemas/ubl24/" + sPart;
          final String sPrevFilename = aFile.getName ().replace ("2.5", "2.4");
          if (!new File (sPrevBasePath, sPrevFilename).exists ())
            aSB.append ("@Since (\"2.5\")\n");
        }

        // APPLICATION_RESPONSE
        // (oasis.names.specification.ubl.schema.xsd.applicationresponse_25.ApplicationResponseType.class,
        ...
        aSB.append (sDocTypeUC)
           ...
           .append (".")
           .append (sDocTypeCC)
           .append ("Type.class, UBL25Marshaller.getAll")
           .append (sDocTypeCC)
           .append ("XSDs ()),\n");
      }
    }
