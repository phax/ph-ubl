...
public enum EUBL21DocumentType implements IJAXBDocumentType
{
  ...
  TENDER_QUALIFICATION (oasis.names.specification.ubl.schema.xsd.tendererqualification_21.TendererQualificationType.class,
                        "UBL-TendererQualification-2.1.xsd"),
  TENDER_QUALIFICATION_RESPONSE (oasis.names.specification.ubl.schema.xsd.tendererqualificationresponse_21.TendererQualificationResponseType.class,
  ...
  private EUBL21DocumentType (@Nonnull final Class <?> aClass, @Nonnull final String sXSDPath)
  {
    m_aDocType = new JAXBDocumentType (aClass,
                                       new CommonsArrayList <> (CUBL21.SCHEMA_DIRECTORY + sXSDPath),
