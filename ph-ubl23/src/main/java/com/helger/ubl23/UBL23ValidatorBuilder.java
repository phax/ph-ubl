...
{
  public UBL23ValidatorBuilder (@Nonnull final EUBL23DocumentType eDocType)
  {
    super (eDocType);
  }

  public UBL23ValidatorBuilder (@Nonnull final Class <JAXBTYPE> aClass)
  {
   ...
   */
  @Nonnull
  public static <T> UBL23ValidatorBuilder <T> create (@Nonnull final Class <T> aClass)
  {
    return new UBL23ValidatorBuilder <> (aClass);
  }
}
