...
/**
 * UBL document type map. Provides sanity methods for accessing UBL 2.3 document
...
public final class UBL23DocumentTypes
{
  ...
  static
  {
    // Register all UBL 2.3 document types
  ...
  private static final UBL23DocumentTypes s_aInstance = new UBL23DocumentTypes ();

  private UBL23DocumentTypes ()
  {}

  /**
   * @return A non-<code>null</code> set of all supported UBL 2.3 namespaces.
   */
  @Nonnull
  @ReturnsMutableCopy
   ...
   *
   * @param sNamespace
   *        The namespace URI of any UBL 2.3 document type. May be
   *        <code>null</code>.
   * @return <code>null</code> if no UBL 2.3 document type matching the
   *         specified namespace URI exists.
   */
  @Nullable
  public static EUBL23DocumentType getDocumentTypeOfNamespace (@Nullable final String sNamespace)
  {
   ...
   *        The namespace URI of any UBL 2.3 document type. May be
   *        <code>null</code>.
   * @return <code>null</code> if no such UBL 2.3 document type exists.
   */
  @Nullable
  public static Class <?> getImplementationClassOfNamespace (@Nullable final String sNamespace)
  {
    final EUBL23DocumentType eDocType = getDocumentTypeOfNamespace (sNamespace);
   ...
   *         or if no UBL 2.3 document type has the specified implementation
   *         class.
   */
  @Nullable
  public static EUBL23DocumentType getDocumentTypeOfImplementationClass (@Nullable final Class <?> aImplClass)
  {
    if (aImplClass == null)
      return null;
  ...
  /**
   * Get the XSD Schema object for the UBL 2.3 document type of the passed
   * namespace.
   *
   * @param sNamespace
   *        The namespace URI of any UBL 2.3 document type. May be
   ...
   *
   * @param sLocalName
   *        The document element local name of any UBL 2.3 document type. May be
   *        <code>null</code>.
   * @return <code>null</code> if no UBL 2.3 document type matching the
   *         specified local name exists.
   */
  @Nullable
  public static EUBL23DocumentType getDocumentTypeOfLocalName (@Nullable final String sLocalName)
  {
  ...
  {
    final EUBL23DocumentType eDocType = getDocumentTypeOfLocalName (sLocalName);
    return eDocType == null ? null : eDocType.getImplementationClass ();
  }
   ...
   *
   * @param aImplClass
   *        The implementation class of any UBL 2.3 document type. May be
   *        <code>null</code>.
   * @return <code>null</code> if no such UBL 2.3 document type exists.
   */
  @Nullable
  ...
  {
    final EUBL23DocumentType eDocType = getDocumentTypeOfImplementationClass (aImplClass);
    return eDocType == null ? null : eDocType.getSchema ();
  }
}
