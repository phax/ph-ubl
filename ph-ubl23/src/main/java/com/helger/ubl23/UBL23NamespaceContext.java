...
public class UBL23NamespaceContext extends MapBasedNamespaceContext
{
  ...
  {
    static final UBL23NamespaceContext s_aInstance = new UBL23NamespaceContext ();
  }
  ...
  protected UBL23NamespaceContext ()
  {
    ...
    addMapping ("cac", CUBL23.XML_SCHEMA_CAC_NAMESPACE_URL);
    addMapping ("cbc", CUBL23.XML_SCHEMA_CBC_NAMESPACE_URL);
    addMapping ("cec", CUBL23.XML_SCHEMA_CEC_NAMESPACE_URL);
    addMapping ("csc", CUBL23.XML_SCHEMA_CSC_NAMESPACE_URL);
