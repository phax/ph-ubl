...
public class MainCreateUBL20ActionCode extends AbstractCreateUBLActionCode
{
  ...
  public static void main (final String [] args)
  {
    ...
    SimpleFileIO.writeFile (new File ("src/main/java/com/helger/ubl/UBL20Reader.java"),
                            aSB.append ("}").toString (),
    ...
    SimpleFileIO.writeFile (new File ("src/main/java/com/helger/ubl/UBL20Writer.java"),
                            aSB.append ("}").toString (),
                            CCharset.CHARSET_UTF_8_OBJ);
    ...
    SimpleFileIO.writeFile (new File ("src/main/java/com/helger/ubl/UBL20Validator.java"),
                            aSB.append ("}").toString (),
                            CCharset.CHARSET_UTF_8_OBJ);
