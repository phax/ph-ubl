...
/**
 * Validate all UBLTR document types.
 *
...
public final class UBLTRValidator
{
  ...
  /**
   * Create a validation builder for CancelUserAccountType.
   *
  ...
  /**
   * Create a validation builder for ProcessUserAccountType.
   *
   * @return The builder and never <code>null</code>
   */
  @Nonnull
  ...
  /**
   * Create a validation builder for TRPackage.<br>
