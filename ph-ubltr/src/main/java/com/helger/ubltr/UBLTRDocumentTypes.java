...
public final class UBLTRDocumentTypes
{
  ...
  private static final Map <String, EUBLTRDocumentType> s_aNamespace2DocType = new HashMap <String, EUBLTRDocumentType> ();

  /** Maps local names to document types */
  private static final Map <String, EUBLTRDocumentType> s_aLocalName2DocType = new HashMap <String, EUBLTRDocumentType> ();
