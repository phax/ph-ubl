    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static ELanguageCode23 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(ELanguageCode23 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final ELanguageCode23 eValue = ELanguageCode23 .getFromIDOrNull(sID);
