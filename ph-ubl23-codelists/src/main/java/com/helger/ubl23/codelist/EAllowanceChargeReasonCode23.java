 ...
 * AllowanceChargeReasonCode-2.3.gc. Do NOT edit! It contains a total of 105
 * entries!
 * 
 * @author com.helger.ubl23.main.MainCreateEnumsGenericode23
 */
@CodingStyleguideUnaware
public enum EAllowanceChargeReasonCode23 implements IHasID <String>, IHasDisplayName
{
  ...
  private EAllowanceChargeReasonCode23 (@Nonnull @Nonempty final String sID,
