    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static EUnitOfMeasureCode23 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EUnitOfMeasureCode23 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final EUnitOfMeasureCode23 eValue = EUnitOfMeasureCode23 .getFromIDOrNull(sID);
