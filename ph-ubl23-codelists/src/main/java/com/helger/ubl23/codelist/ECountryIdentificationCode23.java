    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static ECountryIdentificationCode23 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(ECountryIdentificationCode23 .class, sID);
    }
