...
/**
 * This file was automatically generated from Genericode file PackagingTypeCode-2.3.gc. Do NOT edit!
 * It contains a total of 399 entries!
 * @author com.helger.ubl23.main.MainCreateEnumsGenericode23
 */
@CodingStyleguideUnaware
public enum EPackagingTypeCode23
    implements IHasID<String> , IHasDisplayName
{
    ...
    OG("OG", "Pallet ISO 0 - 1/2 EURO Pallet", null, "Standard pallet with dimensions 80 X 60 cm.", "92"),
    OH("OH", "Pallet ISO 1 - 1/1 EURO Pallet", null, "Standard pallet with dimensions 80 X 120 cm.", "92"),
    OI("OI", "Pallet ISO 2 \u2013 2/1 EURO Pallet", null, "Standard pallet with dimensions 100 X 120 cm.", "92"),
    OJ("OJ", "1/4 EURO Pallet", null, "Standard pallet with dimensions 60 X 40 cm.", "92"),
    OL("OL", "1/8 EURO Pallet", null, "Standard pallet with dimensions 40 X 30 cm.", "92"),
    OM("OM", "Synthetic pallet ISO 1", null, "A standard pallet with standard dimensions 80 x 120cm made of a synthetic material for hygienic reasons.", "92"),
    ON("ON", "Synthetic pallet ISO 2", null, "A standard pallet with standard dimensions 100 x 120cm made of a synthetic material for hygienic reasons.", "92"),
    OP("OP", "Wholesaler pallet", null, "Pallet provided by the wholesaler.", "92"),
    OQ("OQ", "Pallet 80 X 100 cm", null, "Pallet with dimensions 80 X 100 cm.", "92"),
    OR("OR", "Pallet 60 X 100 cm", null, "Pallet with dimensions 60 X 100 cm.", "92"),
    OS("OS", "Oneway pallet", null, "Pallet need not be returned to the point of expedition", "92"),
    OV("OV", "Returnable pallet", null, "Pallet must be returned to the point of expedition.", "92"),
    OW("OW", "Large bag, pallet sized", null, "A non-rigid container made of fabric, paper, plastic, etc, with an opening at the top which can be closed and which is suitable for use on pallets", "92"),
    OX("OX", "A wheeled pallet with raised rim (81 x 67 x 135)", null, "A wheeled pallet with raised rim for the storing and transporting of loads. Dimensions: 81 x 67 x 135 cm (length x width x height).", "92"),
    OY("OY", "A Wheeled pallet with raised rim (81 x 72 x 135)", null, "A wheeled pallet with raised rim for the storing and transporting of loads. Dimensions: 81 x 72 x 135 cm (length x width x height).", "92"),
    OZ("OZ", "Wheeled pallet with raised rim ( 81 x 60 x 16)", null, "A wheeled pallet with raised rim for the storing and transporting of loads. Dimensions: 81 x 60 x 16 cm (length x width x height).", "92"),
    O1("O1", "Two sided cage on wheels with fixing strap", null, "A two sided cage mounted on wheels with fixing strap. Dimensions: 900 x 770 x 1513 cm (length x width x height).", "92"),
    O2("O2", "Trolley", null, "A low cart for the transportation and storage of groceries, milk, etc.", "92"),
    O3("O3", "Oneway pallet ISO 0 - 1/2 EURO Pallet", null, "Oneway pallet with dimensions 80 X 60 cm.", "92"),
    O4("O4", "Oneway pallet ISO 1 - 1/1 EURO Pallet", null, "Oneway pallet with dimensions 80 X 120 cm.", "92"),
    O5("O5", "Oneway pallet ISO 2 - 2/1 EURO Pallet", null, "Oneway pallet with dimensions 100 X 120 cm.", "92"),
    O6("O6", "Pallet with exceptional dimensions", null, "Pallet with non-standard dimensions", "92"),
    ...
    private EPackagingTypeCode23(@Nonnull @Nonempty final String sID,
    ...
    @Nullable
    public static EPackagingTypeCode23 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EPackagingTypeCode23 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final EPackagingTypeCode23 eValue = EPackagingTypeCode23 .getFromIDOrNull(sID);
