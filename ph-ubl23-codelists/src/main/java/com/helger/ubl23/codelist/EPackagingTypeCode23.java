    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_ID = "UNECE Recommendation 21 - Codes for Passengers, Types of Cargo,       Packages and Packaging Materials (with Complementary Codes for Package Names)";
    public static final String LIST_VERSION = "10e_2019";
