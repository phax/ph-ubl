 ...
 * TransportEquipmentTypeCode-2.3.gc. Do NOT edit! It contains a total of 96
 * entries!
 * 
 * @author com.helger.ubl23.main.MainCreateEnumsGenericode23
 */
@CodingStyleguideUnaware
public enum ETransportEquipmentTypeCode23 implements IHasID <String>, IHasDisplayName
{
  ...
  EGD ("EGD",
       "Pallet modular collars 80*100",
       "Collars, with the dimensions 80cms * 100cms, which when fitted onto a pallet enable the pallet to be transformed into a box pallet with, if necessary, a lid."),
  EGE ("EGE",
       "Pallet modular collars 80*120",
       "Collars, with the dimensions 80cms * 120cms, which when fitted onto a pallet enable the pallet to be transformed into a box pallet with, if necessary, a lid."),
  ...
  EGI ("EGI",
       "Landside power generator",
       "A generator located landside at a terminal, used to provide electric power to a vessel or other means of transport."),
  ...
  private ETransportEquipmentTypeCode23 (@Nonnull @Nonempty final String sID,
  ...
  @Nullable
  public static ETransportEquipmentTypeCode23 getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (ETransportEquipmentTypeCode23.class, sID);
  }

  @Nullable
  public static String getDisplayNameFromIDOrNull (@Nullable final String sID)
  {
    final ETransportEquipmentTypeCode23 eValue = ETransportEquipmentTypeCode23.getFromIDOrNull (sID);
