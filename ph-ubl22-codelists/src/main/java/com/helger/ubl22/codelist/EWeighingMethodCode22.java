 ...
 * WeighingMethodCode-2.2.gc. Do NOT edit! It contains a total of 2 entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum EWeighingMethodCode22 implements IHasID <String>, IHasDisplayName
{
  ...
  private EWeighingMethodCode22 (@Nonnull @Nonempty final String sID,
