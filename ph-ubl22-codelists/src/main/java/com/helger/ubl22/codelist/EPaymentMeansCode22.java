 ...
 * PaymentMeansCode-2.2.gc. Do NOT edit! It contains a total of 82 entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum EPaymentMeansCode22 implements IHasID <String>, IHasDisplayName
{
  _1 ("1",
  ...
  private EPaymentMeansCode22 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription)
  {
    m_sID = sID;
  ...
  @Nullable
  public static EPaymentMeansCode22 getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EPaymentMeansCode22.class, sID);
  }

  @Nullable
  public static String getDisplayNameFromIDOrNull (@Nullable final String sID)
  {
    final EPaymentMeansCode22 eValue = EPaymentMeansCode22.getFromIDOrNull (sID);
