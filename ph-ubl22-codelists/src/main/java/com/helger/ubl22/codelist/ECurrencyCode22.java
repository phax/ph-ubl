 ...
 * CurrencyCode-2.2.gc. Do NOT edit! It contains a total of 275 entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum ECurrencyCode22 implements IHasID <String>, IHasDisplayName
{
  ...
  PHP ("PHP", "Philippine Piso", "608", "2", "PHILIPPINES (THE)"),
  ...
  SZL ("SZL", "Lilangeni", "748", "2", "SWAZILAND"),
  ...
  UYI ("UYI", "Uruguay Peso en Unidades Indexadas (URUIURUI)", "940", "0", "URUGUAY"),
  UYU ("UYU", "Peso Uruguayo", "858", "2", "URUGUAY"),
  UZS ("UZS", "Uzbekistan Sum", "860", "2", "UZBEKISTAN"),
  VEF ("VEF", "Bol\u00edvar", "937", "2", "VENEZUELA (BOLIVARIAN REPUBLIC OF)"),
  ...
  @Nullable
  public static ECurrencyCode22 getFromIDOrNull (@Nullable final String sID)
  {
