 ...
 * AllowanceChargeReasonCode-2.2.gc. Do NOT edit! It contains a total of 105
 * entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum EAllowanceChargeReasonCode22 implements IHasID <String>, IHasDisplayName
{
  ...
  private EAllowanceChargeReasonCode22 (@Nonnull @Nonempty final String sID,
  ...
  @Nullable
  public static EAllowanceChargeReasonCode22 getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EAllowanceChargeReasonCode22.class, sID);
  }

  @Nullable
  public static String getDisplayNameFromIDOrNull (@Nullable final String sID)
  {
    final EAllowanceChargeReasonCode22 eValue = EAllowanceChargeReasonCode22.getFromIDOrNull (sID);
