    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_ID = "ISO 3166";
    public static final String LIST_VERSION = "2018-02-14";
    ...
    private ECountryIdentificationCode22(@Nonnull @Nonempty final String sID,
    ...
    @Nullable
    public static ECountryIdentificationCode22 getFromIDOrNull(@Nullable final String sID) {
