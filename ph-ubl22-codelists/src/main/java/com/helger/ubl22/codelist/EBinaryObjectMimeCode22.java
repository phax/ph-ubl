 ...
 * It contains a total of 1597 entries!
    ...
    implements IHasID<String>
{
    ...
    application_activemessage_1("application/activemessage"),
    ...
    application_smil___OBSOLETED_in_favor_of_application_smil_xml("application/smil - OBSOLETED in favor of application/smil+xml"),
    ...
    application_vnd_arastra_swi___OBSOLETED_in_favor_of_application_vnd_aristanetworks_swi("application/vnd.arastra.swi - OBSOLETED in favor of application/vnd.aristanetworks.swi"),
    ...
    application_vnd_geo_json__OBSOLETED_by__in_favor_of_application_geo_json_("application/vnd.geo+json (OBSOLETED by  in favor of application/geo+json)"),
    application_vnd_geocube_xml___OBSOLETED_by_request("application/vnd.geocube+xml - OBSOLETED by request"),
    ...
    application_vnd_gmx___DEPRECATED("application/vnd.gmx - DEPRECATED"),
    ...
    application_vnd_informix_visionary___OBSOLETED_in_favor_of_application_vnd_visionary("application/vnd.informix-visionary - OBSOLETED in favor of application/vnd.visionary"),
    ...
    application_vnd_macports_portpkg_1("application/vnd.macports.portpkg"),
    ...
    application_vnd_nokia_n_gage_symbian_install___OBSOLETE__no_replacement_given("application/vnd.nokia.n-gage.symbian.install - OBSOLETE; no replacement given"),
    ...
    audio_vnd_qcelp___DEPRECATED_in_favor_of_audio_qcelp("audio/vnd.qcelp - DEPRECATED in favor of audio/qcelp"),
    ...
    image_wmf("image/wmf"),
    image_x_emf___DEPRECATED_in_favor_of_image_emf("image/x-emf - DEPRECATED in favor of image/emf"),
    image_x_wmf___DEPRECATED_in_favor_of_image_wmf("image/x-wmf - DEPRECATED in favor of image/wmf"),
    ...
    message_news___OBSOLETED_by_RFC5537("message/news - OBSOLETED by RFC5537"),
    ...
    message_vnd_si_simp___OBSOLETED_by_request("message/vnd.si.simp - OBSOLETED by request"),
    ...
    text_directory___DEPRECATED_by_RFC6350("text/directory - DEPRECATED by RFC6350"),
    text_dns("text/dns"),
    text_ecmascript___OBSOLETED_in_favor_of_application_ecmascript("text/ecmascript - OBSOLETED in favor of application/ecmascript"),
    ...
    text_html("text/html"),
    text_javascript___OBSOLETED_in_favor_of_application_javascript("text/javascript - OBSOLETED in favor of application/javascript"),
    ...
    text_vnd_si_uricatalogue___OBSOLETED_by_request("text/vnd.si.uricatalogue - OBSOLETED by request"),
    ...
    private EBinaryObjectMimeCode22(
        @Nonnull
        @Nonempty
        final String sID) {
        m_sID = sID;
    ...
    @Nullable
    public static EBinaryObjectMimeCode22 getFromIDOrNull(
        @Nullable
        final String sID) {
        return EnumHelper.getFromIDOrNull(EBinaryObjectMimeCode22 .class, sID);
    }
}
