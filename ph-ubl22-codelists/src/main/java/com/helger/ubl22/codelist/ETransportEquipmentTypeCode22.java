 ...
 * TransportEquipmentTypeCode-2.2.gc. Do NOT edit! It contains a total of 95
 * entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum ETransportEquipmentTypeCode22 implements IHasID <String>, IHasDisplayName
{
  ...
  private ETransportEquipmentTypeCode22 (@Nonnull @Nonempty final String sID,
  ...
  @Nullable
  public static ETransportEquipmentTypeCode22 getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (ETransportEquipmentTypeCode22.class, sID);
  }
