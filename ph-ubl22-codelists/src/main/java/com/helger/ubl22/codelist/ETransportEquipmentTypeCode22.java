...
public enum ETransportEquipmentTypeCode22
    implements IHasID<String> , IHasDisplayName
{
    ...
    private ETransportEquipmentTypeCode22(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription) {
        m_sID = sID;
