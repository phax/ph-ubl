 ...
 * TransportModeCode-2.2.gc. Do NOT edit! It contains a total of 10 entries!
 * 
 * @author com.helger.ubl22.main.MainCreateEnumsGenericode22
 */
@CodingStyleguideUnaware
public enum ETransportModeCode22 implements IHasID <String>, IHasDisplayName
{
  _0 ("0",
  ...
  private ETransportModeCode22 (@Nonnull @Nonempty final String sID,
  ...
  @Nullable
  public static ETransportModeCode22 getFromIDOrNull (@Nullable final String sID)
  {
