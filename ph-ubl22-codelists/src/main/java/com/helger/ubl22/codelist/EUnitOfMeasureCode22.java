    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_ID = "UNECE Recommendation N\u00b0. 20 - Codes for Units of Measure Used in International Trade";
    public static final String LIST_VERSION = "12e_2016";
    private final String m_sID;
    private final String m_sDisplayName;

    private EUnitOfMeasureCode22(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName) {
        m_sID = sID;
    ...
    @Nullable
    public static EUnitOfMeasureCode22 getFromIDOrNull(@Nullable final String sID) {
