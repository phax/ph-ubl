    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static EPackagingTypeCode22 getFromIDOrNull(
        @Nullable
        final String sID) {
        return EnumHelper.getFromIDOrNull(EPackagingTypeCode22 .class, sID);
    }
    ...
    public static String getDisplayNameFromIDOrNull(
        @Nullable
        final String sID) {
        final EPackagingTypeCode22 eValue = EPackagingTypeCode22 .getFromIDOrNull(sID);
