 ...
 */
public final class MainCreateEnumsGenericode24
{
  private static final String PACKAGE = "com.helger.ubl24.codelist";
                                           ...
                                           final CodeListDocument aCodeList10) throws JCodeModelException
  {
    ...
    if (aFile.getName ().equals ("BinaryObjectMimeCode-2.4.gc") || aFile.getName ().equals ("UnitOfMeasureCode-2.4.gc"))
    {
                                     ...
                                     final boolean bHasNameColumn) throws JCodeModelException
  {
    ...
    jEnum.javadoc ().add ("@author " + MainCreateEnumsGenericode24.class.getName ());
                                              ...
                                              final boolean bHasNameColumn) throws JCodeModelException
  {
    ...
    jClass.javadoc ().add ("@author " + MainCreateEnumsGenericode24.class.getName ());
