...
public class UBL20NamespacePrefixMapperOracleRT extends NamespacePrefixMapper
{
  private static final class SingletonHolder
  {
    static final UBL20NamespacePrefixMapperOracleRT s_aInstance = new UBL20NamespacePrefixMapperOracleRT ();
  }

  protected UBL20NamespacePrefixMapperOracleRT ()
  {}

  @Nonnull
  public static UBL20NamespacePrefixMapperOracleRT getInstance ()
  {
                                    ...
                                    final boolean bRequirePrefix)
  {
    ...
    if (sNamespaceUri.equals (CUBL20.XML_SCHEMA_CAC_NAMESPACE_URL))
      return "cac";
    if (sNamespaceUri.equals (CUBL20.XML_SCHEMA_CBC_NAMESPACE_URL))
      return "cbc";
    if (sNamespaceUri.equals (CUBL20.XML_SCHEMA_CEC_NAMESPACE_URL))
      return "cec";
    return sSuggestion;
  }
}
