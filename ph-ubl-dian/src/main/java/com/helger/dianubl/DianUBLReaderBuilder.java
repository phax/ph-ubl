...
/**
 * A reader builder for DIAN UBL documents.
 *
...
public class DianUBLReaderBuilder <JAXBTYPE> extends JAXBReaderBuilder <JAXBTYPE, DianUBLReaderBuilder <JAXBTYPE>>
{
  ...
  public DianUBLReaderBuilder (@Nonnull final Class <JAXBTYPE> aClass)
  {
    this (DianUBLDocumentTypes.getDocumentTypeOfImplementationClass (aClass), aClass);
  }
   ...
   */
  @Nonnull
  public static <T> DianUBLReaderBuilder <T> create (@Nonnull final Class <T> aClass)
  {
    return new DianUBLReaderBuilder <> (aClass);
  }
   ...
   */
  @Nonnull
  public static DianUBLReaderBuilder <?> createGeneric (@Nonnull final EDianUBLDocumentType eDocType)
  {
    return new DianUBLReaderBuilder <> (eDocType, Object.class);
  }
}
