...
public final class DianUBLValidator
{
  ...
  /**
   * Create a validation builder for {@link DianExtensionsType}.
   *
   * @return The builder and never <code>null</code>
   */
  @Nonnull
  public static DianUBLValidatorBuilder <DianExtensionsType> dianExtensions ()
  {
    return DianUBLValidatorBuilder.create (DianExtensionsType.class);
  }
