...
/**
 * This file was automatically generated from Genericode file LongitudeDirectionCode-2.0.gc. Do NOT edit!
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    ELongitudeDirectionCode20(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName) {
        m_sID = sID;
