...
/**
 * This file is generated from Genericode file CountryIdentificationCode-2.0.gc. Do NOT edit!
 * 
 */
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    private ECountryIdentificationCode20(
        @Nonnull
        @Nonempty
        final String sID,
        @Nonnull
    ...
    @Nullable
    public static ECountryIdentificationCode20 getFromIDOrNull(
        @Nullable
        final String sID) {
