...
/**
 * This file is generated from Genericode file TransportationStatusCode-2.0.gc. Do NOT edit!
 * 
 */
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    private ETransportationStatusCode20(
        @Nonnull
        @Nonempty
        final String sID,
        @Nonnull
    ...
    @Nullable
    public static ETransportationStatusCode20 getFromIDOrNull(
        @Nullable
        final String sID) {
