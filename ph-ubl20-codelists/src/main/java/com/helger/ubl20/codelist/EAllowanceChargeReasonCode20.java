...
/**
 * This file was automatically generated from Genericode file AllowanceChargeReasonCode-2.0.gc. Do
 * NOT edit! It contains a total of 90 entries!
 *
...
public enum EAllowanceChargeReasonCode20 implements IHasID <String>, IHasDisplayName
{
  ...
  EAllowanceChargeReasonCode20 (@NonNull @Nonempty final String sID, @NonNull final String sDisplayName)
  {
    m_sID = sID;
