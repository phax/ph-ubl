...
/**
 * This file is generated from Genericode file LanguageCode-2.0.gc. Do NOT edit!
 * 
 */
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static ELanguageCode20 getFromIDOrNull(
        @Nullable
        final String sID) {
    ...
    @Nullable
    public static ELanguageCode20 getFromJAXBOrNull(
        @Nullable
        final LanguageCodeContentType aID) {
