...
/**
 * This file is generated from Genericode file PackagingTypeCode-2.0.gc. Do NOT edit!
 * 
 */
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    @Nullable
    public static EPackagingTypeCode20 getFromIDOrNull(
        @Nullable
        final String sID) {
