...
/**
 * This file was automatically generated from Genericode file UnitOfMeasureCode-2.0.gc. Do NOT edit!
 * It contains a total of 1093 entries!
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_ID = "UN/ECE rec 20";
    public static final String LIST_VERSION = "Revision 4";
    private final String m_sID;
    private final String m_sDisplayName;

    private EUnitOfMeasureCode20(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName) {
        m_sID = sID;
    ...
    @Nullable
    public static EUnitOfMeasureCode20 getFromIDOrNull(@Nullable final String sID) {
