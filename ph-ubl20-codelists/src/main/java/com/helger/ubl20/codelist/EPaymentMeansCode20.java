...
/**
 * This file is generated from Genericode file PaymentMeansCode-2.0.gc. Do NOT
 * edit!
 */
@CodingStyleguideUnaware
public enum EPaymentMeansCode20 implements IHasID <String>, IHasDisplayName
{
  ...
  private EPaymentMeansCode20 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName)
  {
    m_sID = sID;
  ...
  @Nullable
  public static EPaymentMeansCode20 getFromIDOrNull (@Nullable final String sID)
  {
