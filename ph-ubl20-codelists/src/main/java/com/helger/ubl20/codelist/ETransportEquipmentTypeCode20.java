...
/**
 * This file is generated from Genericode file TransportEquipmentTypeCode-2.0.gc. Do NOT edit!
 * 
 */
    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    private ETransportEquipmentTypeCode20(
        @Nonnull
        @Nonempty
        final String sID,
        @Nonnull
    ...
    @Nullable
    public static ETransportEquipmentTypeCode20 getFromIDOrNull(
        @Nullable
        final String sID) {
