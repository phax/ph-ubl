...
/**
 * This file was automatically generated from Genericode file TransportEquipmentTypeCode-2.0.gc. Do NOT edit!
 * It contains a total of 61 entries!
 * @author com.helger.ubl20.main.MainCreateEnumsGenericode20
 */
@CodingStyleguideUnaware
public enum ETransportEquipmentTypeCode20
    implements IHasID<String> , IHasDisplayName
{
    ...
    TS("TS", "Tackles", "[8030] Identification marks and numbers of loading tackle used (sheets, ropes, chains, etc.), as specified in DCU 9 to CIM Article 13; and of containers, as specified in Articles 5 and 10 of Annex III to CIM (CIM 17)."),
    ...
    public static final String LIST_ID = "UN/ECE 8053";
    public static final String LIST_VERSION = "D.05B";
    private final String m_sID;
    private final String m_sDisplayName;
    private final String m_sDescription;

    private ETransportEquipmentTypeCode20(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription) {
        m_sID = sID;
    ...
    @Nullable
    public static ETransportEquipmentTypeCode20 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(ETransportEquipmentTypeCode20 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final ETransportEquipmentTypeCode20 eValue = ETransportEquipmentTypeCode20 .getFromIDOrNull(sID);
