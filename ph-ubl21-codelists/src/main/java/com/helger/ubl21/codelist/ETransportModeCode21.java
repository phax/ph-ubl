 ...
 * TransportModeCode-2.1.gc. Do NOT edit! It contains a total of 10 entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum ETransportModeCode21 implements IHasID <String>, IHasDisplayName
{
  _0 ("0",
  ...
  private ETransportModeCode21 (@Nonnull @Nonempty final String sID,
