...
/**
 * This file was automatically generated from Genericode file UnitOfMeasureCode-2.1.gc. Do NOT edit!
 * It contains a total of 2090 entries!
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EUnitOfMeasureCode21
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_VERSION = "8e";
    private final String m_sID;
    private final String m_sDisplayName;

    private EUnitOfMeasureCode21(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName) {
        m_sID = sID;
    ...
    @Nullable
    public static EUnitOfMeasureCode21 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EUnitOfMeasureCode21 .class, sID);
    }
