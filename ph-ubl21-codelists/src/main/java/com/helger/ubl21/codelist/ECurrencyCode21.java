    ...
    implements IHasID<String> , IHasDisplayName
{
    ...
    public static final String LIST_VERSION = "2012-01-12";
    ...
    @Nullable
    public static ECurrencyCode21 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(ECurrencyCode21 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final ECurrencyCode21 eValue = ECurrencyCode21 .getFromIDOrNull(sID);
