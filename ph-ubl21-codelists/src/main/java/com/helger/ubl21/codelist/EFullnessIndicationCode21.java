 ...
 * FullnessIndicationCode-2.1.gc. Do NOT edit! It contains a total of 13
 * entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EFullnessIndicationCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  private EFullnessIndicationCode21 (@Nonnull @Nonempty final String sID,
  ...
  @Nullable
  public static EFullnessIndicationCode21 getFromIDOrNull (@Nullable final String sID)
  {
