 ...
 * HazardousCategoryCode-2.1.gc. Do NOT edit! It contains a total of 18 entries!
 * 
...
{
  ADR ("ADR",
       "European agreement on the international carriage of dangerous goods on road (ADR)",
  ...
  ADS ("ADS",
       "NDR European agreement for the transport of dangerous goods on the river Rhine",
  ...
  AGS ("AGS",
       "DE, ADR and GGVS combined regulations for combined transport",
  ...
  ANR ("ANR",
       "ADNR, Autorisation de transport de matieres Dangereuses pour la Navigation sur le Rhin",
       "Regulations for dangerous goods transportation on the Rhine."),
  ARD ("ARD",
       "DE, ARD and RID - Combined regulations for combined transport",
  ...
  COM ("COM",
       "DE, ADR, RID, GGVS and GGVE - Combined regulations for combined transport",
  ...
  RGE ("RGE",
       "DE, RID and GGVE, Combined regulations for combined transport on rails",
  ...
  RID ("RID",
       "Railroad dangerous goods book (RID)",
  ...
  private EHazardousCategoryCode21 (@Nonnull @Nonempty final String sID,
