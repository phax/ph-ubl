 ...
 * ReceiptAdviceTypeCode-2.1.gc. Do NOT edit! It contains a total of 3 entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EReceiptAdviceTypeCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  private EReceiptAdviceTypeCode21 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName)
  {
    m_sID = sID;
  ...
  @Nullable
  public static EReceiptAdviceTypeCode21 getFromIDOrNull (@Nullable final String sID)
  {
