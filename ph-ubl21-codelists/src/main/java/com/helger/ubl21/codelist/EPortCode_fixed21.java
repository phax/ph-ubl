...
/**
 * This file was automatically generated from Genericode file PortCode-2.1-fixed.gc. Do NOT edit!
 * It contains a total of 176 entries!
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EPortCode_fixed21
    implements IHasID<String> , IHasDisplayName
{
    ...
    private EPortCode_fixed21(@Nonnull @Nonempty final String sID,
    ...
    @Nullable
    public static EPortCode_fixed21 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EPortCode_fixed21 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final EPortCode_fixed21 eValue = EPortCode_fixed21 .getFromIDOrNull(sID);
