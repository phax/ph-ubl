 ...
 * ItemClassificationCode-2.1.gc. Do NOT edit! It contains a total of 165
 * entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EItemClassificationCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  SRV ("SRV",
       "EAN.UCC Global Trade Item Number",
  ...
  STM ("STM",
       "CLADIMED (Classification des Dispositifs M\u008edicaux)",
  ...
  private EItemClassificationCode21 (@Nonnull @Nonempty final String sID,
