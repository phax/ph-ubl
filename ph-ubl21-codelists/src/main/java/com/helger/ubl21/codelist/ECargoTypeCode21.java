 ...
 * CargoTypeCode-2.1.gc. Do NOT edit! It contains a total of 23 entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum ECargoTypeCode21 implements IHasID <String>, IHasDisplayName
{
  _1 ("1",
      "Documents",
  ...
  @Nullable
  public static ECargoTypeCode21 getFromIDOrNull (@Nullable final String sID)
  {
