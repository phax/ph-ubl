...
/**
 * This file was automatically generated from Genericode file ChannelCode-2.1.gc. Do NOT edit!
 * It contains a total of 47 entries!
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EChannelCode21
    implements IHasID<String> , IHasDisplayName
{
    ...
    private EChannelCode21(@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription) {
        m_sID = sID;
    ...
    @Nullable
    public static EChannelCode21 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EChannelCode21 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final EChannelCode21 eValue = EChannelCode21 .getFromIDOrNull(sID);
