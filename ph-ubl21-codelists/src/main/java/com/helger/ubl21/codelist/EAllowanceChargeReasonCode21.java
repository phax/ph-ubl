 ...
 * AllowanceChargeReasonCode-2.1.gc. Do NOT edit! It contains a total of 98
 * entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EAllowanceChargeReasonCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  private EAllowanceChargeReasonCode21 (@Nonnull @Nonempty final String sID,
