 ...
 * PaymentMeansCode-2.1.gc. Do NOT edit! It contains a total of 75 entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EPaymentMeansCode21 implements IHasID <String>, IHasDisplayName
{
  _1 ("1",
  ...
  private EPaymentMeansCode21 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription)
  {
    m_sID = sID;
