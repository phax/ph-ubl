 ...
 * PartyRoleCode-2.1.gc. Do NOT edit! It contains a total of 20 entries!
 * 
...
public enum EPartyRoleCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  private EPartyRoleCode21 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription)
  {
    m_sID = sID;
  ...
  @Nullable
  public static EPartyRoleCode21 getFromIDOrNull (@Nullable final String sID)
  {
