...
/**
 * This file was automatically generated from Genericode file PortCode-2.1-border.gc. Do NOT edit!
 * It contains a total of 441 entries!
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EPortCode_border21
    implements IHasID<String> , IHasDisplayName
{
    ...
    private EPortCode_border21(@Nonnull @Nonempty final String sID,
    ...
    @Nullable
    public static EPortCode_border21 getFromIDOrNull(@Nullable final String sID) {
        return EnumHelper.getFromIDOrNull(EPortCode_border21 .class, sID);
    }

    @Nullable
    public static String getDisplayNameFromIDOrNull(@Nullable final String sID) {
        final EPortCode_border21 eValue = EPortCode_border21 .getFromIDOrNull(sID);
