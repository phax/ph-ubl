 ...
 * PackageLevelCode-2.1.gc. Do NOT edit! It contains a total of 5 entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum EPackageLevelCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  private EPackageLevelCode21 (@Nonnull @Nonempty final String sID, @Nonnull final String sDisplayName, @Nullable final String sDescription)
  {
    m_sID = sID;
