 ...
 * TransportMeansTypeCode-2.1.gc. Do NOT edit! It contains a total of 260
 * entries!
 * 
 * @author com.helger.ubl21.main.MainCreateEnumsGenericode21
 */
@CodingStyleguideUnaware
public enum ETransportMeansTypeCode21 implements IHasID <String>, IHasDisplayName
{
  ...
  _365 ("365",
        "Truck, freezer with refrigerated trailer",
  ...
  _373 ("373",
        "Truck, tautliner with removable roof and extendable trailer",
  ...
  _375 ("375",
        "Truck, refrigerated with freezer trailer",
  ...
  _379 ("379",
        "Truck, tautliner, removable roof with furniture trailer",
  ...
  _382 ("382",
        "Truck, tautliner, with removable roof and gondola trailer",
  ...
  _387 ("387",
        "Truck, tautliner, removable roof with extendable gondola trailer",
        "Automotive tautliner vehicle designed with a removable roof and with an extendable gondola trailer."),
  _388 ("388",
  ...
  _389 ("389",
        "Truck, bulk with extendable gondola trailer",
        "Automotive vehicle designed for carrying bulk cargo with an extendable gondola trailer."),
  _390 ("390",
        "Truck, tip-up truck with opening-floor trailer",
  ...
  _394 ("394",
        "Truck, bulk truck with opening-floor trailer",
  ...
  _398 ("398",
        "Truck, freezer with freezer trailer",
  ...
  _839 ("839",
        ...
        "Combination designed for pushing/towing, moving nine or more barges of which at least one is a tanker or gas barge."),
  ...
  _852 ("852",
        "Service vessel",
        "A tender (vessel for logistical support), dealing with the transport of small material and maintenance requirements outside the port area on rivers and other inland waterways."),
  _853 ("853", "Police patrol vessel", "A vessel for the supervision by police of applicable rules and regulations."),
  _854 ("854",
        "Port service vessel",
        "A port tender (vessel for logistical support), dealing with the transport of material and people within a port area."),
  _855 ("855",
        "Navigation surveillance vessel",
        "A vessel of the competent authority (waterway) dealing with the surveillance of navigation."),
  ...
  _3101 ("3101",
         "Truck, tautliner with removable roof and removal trailer",
         "Automotive tautline vehicle with removable roof and a trailer capable of carrying household effects."),
  ...
  _3104 ("3104",
         "Truck, tautliner, 25 tonne with removable roof",
  ...
  _3107 ("3107",
         ...
         "Articulated automotive vehicle with a flat bed and 25 tonne capacity with a 15 metre crane attached."),
  _3108 ("3108",
         "Lorry, articulated, flat bed, 24 tonne, with 18 metre crane",
         "Articulated automotive vehicle with a flat bed and 25 tonne capacity with an 18 metre crane attached."),
  _3109 ("3109", "Lorry, articulated, flat bed, 10 tonne", "Articulated automotive vehicle with a flat bed and 10 tonne capacity."),
  _3110 ("3110",
         "Truck, tautliner, 25 tonne, with 90 cubic metre trailer",
         "Automotive tautline vehicle with a 25 tonne capacity and a 90 cubic metre trailer."),
  _3111 ("3111",
         "Truck, tautliner, 25 tonne, with 120 cubic metre trailer",
  ...
  _3135 ("3135",
         "Truck, hydrant",
         "Automotive vehicle designed for the delivery of fuel from a fixed installation to a means of transport."),
  ...
  private ETransportMeansTypeCode21 (@Nonnull @Nonempty final String sID,
